 ...
 *
 * ⚠ COPIED FROM VIDEO 19 (`episode20marketstructure`), not shared. The two
 * episodes are separate branches of the same repo with no common module, and
 * an import across them would tie this build to that one. If the brand mark
 * ever changes it changes in both places, by hand, on purpose.
 */
