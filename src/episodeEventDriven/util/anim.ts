/**
 * PRIVATE COPY — this episode used to read the shared Concept Sector file at
 * src/, which meant a change made for one video silently changed the others.
 * Combining every episode onto one branch is what made that dangerous, so the
 * file was copied in. Contents are unchanged from the shared original.
 */
/**
