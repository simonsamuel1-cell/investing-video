     ...
     <AbsoluteFill style={{ opacity: outOp }}>
      ...
      {frame >= 1122 && (
        <>
          ...
          <div style={{ position: "absolute", left: fx(0.3), top: CTOP + 4, width: 360, fontSize: type.chip, fontWeight: font.weights.bold, fontStyle: "italic", color: colors.slate, opacity: bands10 }}>
            Late accumulation, as price begins to move
          </div>
          <div style={{ position: "absolute", left: fx(0.72), top: CTOP + 4, width: 360, fontSize: type.chip, fontWeight: font.weights.bold, fontStyle: "italic", color: colors.slate, opacity: bands10, textAlign: "right" }}>
