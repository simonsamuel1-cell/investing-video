/**
 * Scene 22 — Three steps intro (5609, dur 180). The rail's three cards (1 Screen ·
...
export const Scene22 = () => {
  ...
  return (
    <SafeArea>
      ...
      <div style={{ position: "absolute", left: 96, top: 280, width: 1728, textAlign: "center", fontSize: type.header, fontWeight: font.weights.extrabold, color: colors.text, ...textReveal(f, 8, 18) }}>
        Three Steps
      </div>
