...
export const SceneEntryPoints = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity: out }}>
      ...
      <div style={{ position: "absolute", left: 0, right: 0, top: 410, display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
        <div style={{ fontSize: 98, fontWeight: 800, letterSpacing: -1, color: COLORS.black, opacity: t1 }}>Different entry points</div>
        <div style={{ fontSize: 98, fontWeight: 800, letterSpacing: -1, color: COLORS.purple, opacity: t2 }}>Same tool</div>
      </div>
    </AbsoluteFill>
  );
};
